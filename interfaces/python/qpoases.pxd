...
cdef extern from "qpOASES/extras/SolutionAnalysis.hpp" namespace "qpOASES":
    cdef cppclass SolutionAnalysis:
        ...
        const real_t getKktViolation(const QProblem*,  const real_t*, const real_t*, const real_t*)
        const real_t getKktViolation(const QProblemB*, const real_t*, const real_t*, const real_t*)
        const real_t getKktViolation(const SQProblem*, const real_t*, const real_t*, const real_t*)
